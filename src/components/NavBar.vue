<template>
  <nav
    class="shadow-lg p-2 shadow-stone-950/5 mx-auto w-full bg-stone-950 dark:bg-surface-dark"
  >
    <div class="flex items-center text-white">
      ...
      <a
        href="#"
        class="font-sans antialiased text-xl text-current ml-2 mr-2 block py-1 font-semibold"
        >Wello</a
      >
      <hr
        class="ml-1 mr-1.5 hidden h-5 w-px border-l border-t-0 border-surface/25 lg:block dark:border-surface"
      />
      <div class="hidden lg:block">
        <ul
          class="mt-4 flex flex-col gap-x-3 gap-y-1.5 lg:mt-0 lg:flex-row lg:items-center"
        >
          <li>
            <a
              href="#"
              class="font-sans antialiased text-sm flex items-center gap-x-2 p-1 text-white hover:text-white"
              ><svg
                width="1.5em"
                height="1.5em"
                viewBox="0 0 24 24"
